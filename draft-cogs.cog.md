...
description: "Draft specification of the .cog.md file format. Cogs are an OPTIONAL layer on top of MX, not an extension of MX. A document does not need to be a cog to carry MX metadata; this note describes the additional fields and identification mechanisms a cog declares so that agents and runtimes can navigate, depend on, and execute it. Authored by Tom Cranstoun and offered to The Gathering for review."
...
mx:
  ...
  tags: [draft, cogs, optional-layer, conformance, specification]
  audience: [humans, machines]
  cacheability: permanent
  runbook: "This is the MX Cogs note — a draft authored by Tom Cranstoun, offered to The Gathering for review. It defines the .cog.md file format as an optional layer on top of MX. Read §1 for positioning, §4-§5 for the cog identification mechanism (magic-header comment + cogHeader frontmatter field), and §6 for the cog structural fields. This note stands alone; it does not depend on any other draft."
---
